    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-violet-600 hover:bg-violet-700 text-white shadow-md shadow-violet-200 hover:shadow-violet-300': variant === 'primary',
            ...
            'border border-violet-300 hover:border-violet-500 text-violet-600 hover:bg-violet-50': variant === 'outline',
